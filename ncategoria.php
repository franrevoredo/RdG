...
<html>
    ...
    <body>	    <div class="body_container"><div class="logos"><img src="img/logo.png"  width="311" height="47"></div>
	    ...
	    <div id="wrapper">
		<div id="content"><div id='formulario' class='formulario'><form accept-charset="UTF-8" id="form" action="go_ncat.php" method="post" >
				<ul>
				    <li>
					<div class="titulo-form">Nueva Categoría</div>
				    </li>

				    <li>
					<label for="ncat">Nombre:</label>
					<input name="ncat" placeholder="Nombre de la Categoría" id="user" size="33" required/>
				    </li>				           
				    <li>
					<label for="desc">Descripción:</label>
					<input type="text" name="desc" placeholder="Descripción de la Categoría" id="pass" size="50" required/>
				    </li>
